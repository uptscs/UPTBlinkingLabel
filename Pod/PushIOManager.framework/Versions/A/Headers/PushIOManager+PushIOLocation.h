...
/**
 ...
 Note that you can either use the PushIOManager managed CLLocationManager, just by telling PushIOManager to `startMonitoringLocation`, or by using your own CLLocationManager and passing in any location updates via `assignLocation`.
 */
...
/**
 Use this call to tell the pushIOManager when location changes (for example if you are using your own CLLocationManager).
...
/**
 Clears out any region monitoring.
 */
